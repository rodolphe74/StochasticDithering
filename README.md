...
6 - Les arêtes des triangles n'étant pas toujours bien calés autour d'un point, un post-traitement ((convex hull)[https://en.wikipedia.org/wiki/Convex_hull_algorithms#Algorithms]) est fait pour attenuer les éventuels effets d'escalier entre triangles.
